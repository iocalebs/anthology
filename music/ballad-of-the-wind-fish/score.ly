...
<<
  \new Voice = "melody" {
    \relative c'' {
      ...
      r2 r8 b8  cis8 d8~ | d2 r8 b8 cis8 d8~ | d2 r8 cis8 b8 fis8  | a4. b8~ b2~ |
      b2 r8 b8  cis8 d8~ | d2 r8 a8 d8   g8~ | g2 r8 fis8 e8 fis8~ | fis1 |
      r2 r8 b,8 cis8 d8~ | d2 r8 b8 cis8 d8~ | d2 r8 cis8 b8 fis8  | a4. b8~ b2~ |
      b2 r8  b8 cis8 d8~ | d2 r8 a8 d8   g8~ | g2 r8 fis8 e8 fis8~ | fis1 |
      r1 |
